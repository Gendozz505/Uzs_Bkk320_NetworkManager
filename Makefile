...
HOST_CXX := g++
HOST_CXXFLAGS := -g -O0 -std=c++17 -Wall -Wextra -Wpedantic -pthread -Iinclude
...
TARGET_CXXFLAGS := -O2 -std=c++17 --sysroot ~/Git-projects/sysrootU20 -Wno-psabi -Wformat -Iinclude
